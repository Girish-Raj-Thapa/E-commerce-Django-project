...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0007_alter_customer_user_alter_customer_unique_together'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('payment', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='core.payment')),
            ],
        ),
    ]
